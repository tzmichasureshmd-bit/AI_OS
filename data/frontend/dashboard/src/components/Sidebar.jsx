...
import { LayoutDashboard, Users, Phone, Megaphone, ScrollText, Zap, Moon, Sun, ChevronLeft, ChevronRight, LogOut, UsersRound, Bot } from 'lucide-react'
...
export default function Sidebar({ activeTab, setActiveTab, collapsed, setCollapsed, onLogout, clientData }) {
  ...
  return (
    ...
    >
      ...
      <div onClick={() => setActiveTab('profile')} style={{ display: 'flex', alignItems: 'center', gap: '12px', padding: collapsed ? '0 4px' : '0 14px', marginBottom: '32px', cursor: 'pointer' }}>
